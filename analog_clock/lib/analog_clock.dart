  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (condition == 'sunny' || condition == 'cloudy') {
      if ( (time.hour >= 6 && time.hour < 18)) {
        ...
        Path path = Path()
          ..moveTo(86,72)
          ..cubicTo(131.306295, 71.478662, 135, 79.3046319, 135, 87.9933128)
          ..cubicTo(135, 104.561855, 121.568542, 117.993313, 105, 117.993313)
          ..cubicTo(88.4314575, 117.993313, 75, 104.561855, 75, 87.9933128)
          ..cubicTo(75, 85.6769168, 75.2625307, 83.4218381, 75.7594612, 81.2562078)
          ..cubicTo(78.5624115, 92.59042, 88.7999053, 100.993313, 101, 100.993313)
          ..cubicTo(115.359403, 100.993313, 127, 89.3527163, 127, 74.9933128)
          ..cubicTo(127, 72.0316859, 126.50482, 69.1857144, 125.592737, 66.5336754)
          ..lineTo(125.403481, 66)
          ..close();
        canvas.drawShadow(path, Color(0x88FFEE00), 12.0, true);

        Paint paint = Paint()
          ..shader = gradient.createShader(Rect.fromCircle(center: Offset(96.0, 96.0), radius: 30.0));
    ...
    if (condition == 'cloudy') {
      Path path = Path()
        ...
        ..lineTo(127.068966,86,)..cubicTo(120.40346,86,115,80.627417,115,74,)

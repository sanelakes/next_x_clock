...
class SecIndex extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (index == sec) {
      color = Color(0xFFEC4B26);
    } else if (index <= min) {
      color = Color(0xFF00977A);
    } else {
...
class HouIndex extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return IndexPaint(data: houIndexData01, color: color, angleRadians: index  * 30.0 + 15.0 , offset: 111.0, drawStroke: true, strokeColor: Color(0xFFD1D1D1), strokeData: houStrokeData1,);
  }
}
...
class HouIndexInner extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (index < hour % 12) {
      ...
      sColor = Color(0x60FFFFFF);
      rotation = 90.0;
    } else {
      color = Color(0x80FFFFFF);
      sColor = Color(0x40FFFFFF);
      rotation = 0.0;
    }
...
class DayBgline extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return BgElement(strokeData: dayBGroundLine, strokeColor: Color(0xFFDDDDDD), drawStroke: true, center: true,);
  }
}
...
class CenterPoint extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return BgElement(data: theCenterPoint, color: Color(0xFFEC4B26), center: true,);
  }
}